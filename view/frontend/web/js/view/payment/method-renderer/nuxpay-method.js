 ...
 */
 ...
 function (
     ...
     return Component.extend({
         defaults: {
             template: 'Nuxpay_Merchant/payment/nuxpay-form'
         },
        ...
        afterPlaceOrder: function (quoteId) {
            var request = $.ajax({
                url: url.build('nuxpay/payment/placeOrder'),
                type: 'POST',
                dataType: 'json',
            ...
            request.done(function(response) {
                if (response.status) {
                    var urlToRedir = url.build('nuxpay/payment/walletTypes/'+quoteId);
